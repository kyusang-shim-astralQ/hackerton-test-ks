...
- `/generate-report`를 `data-models.md`의 `ReportData` 형태 샘플(마크다운 본문 + summary + per-step)로 대체. 마크다운/수식/표/KPI/스텝별 수렴 차트가 실제처럼 렌더되어야 함.
